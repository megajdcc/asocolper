...
class UserController extends Controller
{
    ...
    public function getEmpleadosCompaniaPorEntrega(Entrega $entrega){

        $compania = $entrega->compania;

        $empleados = $compania->empleados;

        foreach($empleados as $empleado){
            $empleado->avatar = $empleado->getAvatar();
    ...
    public function getChoferes(){
        $usuarios = User::whereHas('rol',fn(Builder $q) => $q->where('nombre','Chofer'))->get();
