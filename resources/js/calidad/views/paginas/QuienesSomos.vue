   ...
   <b-container fluid class="px-0">
      <b-row class="header-contacto mx-0">
         <b-col cols="12" class="d-flex justify-content-center">
            <h2 class="d-inline">Quienes Somos</h2>
         </b-col>
      </b-row>
      ...
      <b-row class="my-1">
         <b-col cols="12" class="contenido-quienes-somos">
            <b-container :fluid="windowWidth <= 762 ? true : false">
               <b-row>
                  <b-col cols="12">
                     <section v-html="sistema.quienes_somos"></section>
                  </b-col>
               </b-row>
            </b-container>
...
export default {
   ...
   metaInfo(){
      return{
         title: 'Quienes Somos | Villamizar & Jarava Abogados Asociados S.A.S',
         meta:[
            {
               vmid:'description',
               name:'description',
               content: 'SOMOS UNA FIRMA DE ABOGADOS ESPECIALIZADOS, QUE BRINDAMOS ASISTENCIA LEGAL EN DIFERENTES ÁREAS DEL DERECHO, ORIENTADOS BAJO LOS PRINCIPIOS DE LEALTAD, COMPROMISO, ÉTICA, DISCIPLINA Y LEGALIDAD.'.substring(0, 157)+'..'
            }
         ]
      }  
